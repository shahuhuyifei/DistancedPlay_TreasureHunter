...
String treasureCard_uid; // Store the treasure card uid
unsigned long gestureGame_result = 0; // Store gesture game result of this player

uint8_t otherPlayer_Guess = 0; // Storethe gussing decision of the other player
...
static uint8_t outcomingMessage[] = {0, 0}; // Position 0 is treasure card number, 1 is gesture game status of this player
#endif
